...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-border bg-primary/15 dark:bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-primary/10 dark:supports-[backdrop-filter]:bg-background/60">
