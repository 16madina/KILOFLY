...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-border bg-primary/25 dark:bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-primary/20 dark:supports-[backdrop-filter]:bg-background/60 pt-safe">
      <div className="container flex h-16 items-center justify-between">
        <Link to="/" className="flex items-center gap-2 -ml-2 sm:ml-0">
          <img 
            src={kiloFlyLogo} 
            alt="KiloFly" 
